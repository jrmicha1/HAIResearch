...
"<b>Interface:</b></br></br>The main parts of the interface are:</br>Your panel, OneLife Medical's panel,</br>the patient rooms, the timer, and your controls.</br></br><img src=\"./Resources/interface.png\" style=\"width:600px;height:319px;\">",
"To treat patients, you need to assign them to a room with the correct hospital staff.</br>Your hospital only has 6 rooms. Once a staff member is assigned to a room,</br>they cannot be unassigned until the patient has recovered.</br></br><img src=\"./Resources/assigning.png\" style=\"width:600px;height:450px;\">",
