...
public class StatisticsPanel extends JPanel
{
    ...
    public class QueuePanel extends JPanel
    {
        ...
        public void paintComponent(Graphics g)
        {
            ...
            if(isSparse()) currColor = sparseColor;
            else if(isCrowd()) currColor =crowdColor;
            else if(isFull()) currColor = fullColor;
    ...
    private void updateButtons()
    {
        ...
        if(getResourceNum(ResourceType.DOCTOR) == 0)
        {
            if(MainFrame.CONFIG.isRequestMode())
            {
                ...
                if (!linkedGameFrame.peerGameFrame.isAgent() || MainFrame.CONFIG.isHighCoopAgent())
